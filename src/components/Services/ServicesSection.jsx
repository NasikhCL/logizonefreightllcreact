...
<div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
  <div className="service-item rounded h-100 p-5">
    ...
    <p className="mb-4">
      Our AIR FREIGHT service will be one of our strong sectors with
      our quality service and support extended to our customers.
    </p>
...
<div className="service-item rounded h-100 p-5">
  <div className="d-flex align-items-center ms-n5 mb-4">
    ...
    <h4 className="mb-0">Sea Freight</h4>
  </div>
  <p className="mb-4">
    SEA FREIGHT DEPARTMENT is our key of trade with our unique and
    strong client relation based on our reliable network established
    with the experience.
  </p>
  <a className="btn btn-light px-3" href="">
    Read More
...
<div className="service-item rounded h-100 p-5">
  <div className="d-flex align-items-center ms-n5 mb-4">
    ...
    <h4 className="mb-0 make-it-h5">Inland Transportation</h4>
  </div>
  <p className="mb-4">
    Inland Transportation To be the name of supplying all aspects of
    cargo movements, land transportation is our next sector taking
    us to be a comprehensive service..
  </p>
  <a className="btn btn-light px-3" href="">
    Read More
  </a>
...
<div className="service-item rounded h-100 p-5">
  <div className="d-flex align-items-center ms-n5 mb-4">
    ...
    <h4 className="mb-0">Warehouse &amp; Distribution</h4>
  </div>
  <p className="mb-4">
    Warehouse &amp; Distribution To be the name of supplying all
    aspects of cargo movements, land transportation is our next
    sector taking us to be a comprehensive service.
  </p>
  <a className="btn btn-light px-3" href="">
    Read More
  </a>
